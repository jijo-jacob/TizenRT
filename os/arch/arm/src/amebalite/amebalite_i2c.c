...
#if !defined(CONFIG_AMEBALITE_I2CTIMEOSEC) && !defined(CONFIG_AMEBALITE_I2CTIMEOMS)
#define CONFIG_AMEBALITE_I2CTIMEOSEC 0
#define CONFIG_AMEBALITE_I2CTIMEOMS  500	/* Default is 500 milliseconds */
#elif !defined(CONFIG_AMEBALITE_I2CTIMEOSEC)
#define CONFIG_AMEBALITE_I2CTIMEOSEC 0	/* User provided milliseconds */
#elif !defined(CONFIG_AMEBALITE_I2CTIMEOMS)
#define CONFIG_AMEBALITE_I2CTIMEOMS  0	/* User provided seconds */
#endif

/* Interrupt wait time timeout in system timer ticks */

#ifndef CONFIG_AMEBALITE_I2CTIMEOTICKS
#define CONFIG_AMEBALITE_I2CTIMEOTICKS \
	(SEC2TICK(CONFIG_AMEBALITE_I2CTIMEOSEC) + MSEC2TICK(CONFIG_AMEBALITE_I2CTIMEOMS))
#endif

#ifndef CONFIG_AMEBALITE_I2C_DYNTIMEO_STARTSTOP
#define CONFIG_AMEBALITE_I2C_DYNTIMEO_STARTSTOP TICK2USEC(CONFIG_AMEBALITE_I2CTIMEOTICKS)
#endif
...
#define amebalite_i2c_traceevent(p, e, a)
#define amebalite_i2c_tracedump(p)
#endif
...
#define amebalite_I2C_MASTER    1
#define amebalite_I2C_SLAVE     2
...
struct amebalite_trace_s {
	uint32_t status;			/* I2C 32-bit SR2|SR1 status */
	uint32_t count;				/* Interrupt count when status change */
	enum amebalite_intstate_e event;	/* Last event that occurred with this status */
...
struct amebalite_i2c_priv_s {
	const struct i2c_ops_s *ops;	/* Standard I2C operations */
	const struct amebalite_i2c_config_s *config;	/* Port configuration */
	int refs;					/* Referernce count */
	sem_t sem_excl;				/* Mutual exclusion semaphore */
#ifndef CONFIG_I2C_POLLED
	sem_t sem_isr;				/* Interrupt wait semaphore */
#endif
	volatile uint8_t intstate;	/* Interrupt handshake (see enum amebalite_intstate_e) */
	...
	struct amebalite_trace_s trace[CONFIG_I2C_NTRACE];
#endif
...
static inline void amebalite_i2c_modifyreg(FAR struct amebalite_i2c_priv_s *priv, uint16_t offset, uint32_t clearbits, uint32_t setbits);
static inline void amebalite_i2c_sem_wait(FAR struct amebalite_i2c_priv_s *priv);

#ifdef CONFIG_AMEBALITE_I2C_DYNTIMEO
static useconds_t amebalite_i2c_tousecs(int msgc, FAR struct i2c_msg_s *msgs);
#endif							/* CONFIG_AMEBALITE_I2C_DYNTIMEO */

static inline int amebalite_i2c_sem_waitdone(FAR struct amebalite_i2c_priv_s *priv);
static inline void amebalite_i2c_sem_waitstop(FAR struct amebalite_i2c_priv_s *priv);
static inline void amebalite_i2c_sem_post(FAR struct amebalite_i2c_priv_s *priv);
static inline void amebalite_i2c_sem_init(FAR struct amebalite_i2c_priv_s *priv);
static inline void amebalite_i2c_sem_destroy(FAR struct amebalite_i2c_priv_s *priv);

#ifdef CONFIG_I2C_TRACE
static void amebalite_i2c_tracereset(FAR struct amebalite_i2c_priv_s *priv);
static void amebalite_i2c_tracenew(FAR struct amebalite_i2c_priv_s *priv, uint32_t status);
static void amebalite_i2c_traceevent(FAR struct amebalite_i2c_priv_s *priv, enum amebalite_trace_e event, uint32_t parm);
static void amebalite_i2c_tracedump(FAR struct amebalite_i2c_priv_s *priv);
#endif							/* CONFIG_I2C_TRACE */

static void amebalite_i2c_setclock(FAR struct amebalite_i2c_priv_s *priv, uint32_t frequency);
static inline void amebalite_i2c_sendstart(FAR struct amebalite_i2c_priv_s *priv, uint8_t address);
static inline void amebalite_i2c_sendstop(FAR struct amebalite_i2c_priv_s *priv);
static inline uint32_t amebalite_i2c_getstatus(FAR struct amebalite_i2c_priv_s *priv);

static int amebalite_i2c_isr_process(struct amebalite_i2c_priv_s *priv);

#ifndef CONFIG_I2C_POLLED
static int amebalite_i2c_isr(int irq, void *context, FAR void *arg);
...
static int amebalite_i2c_reset(FAR struct i2c_master_s *dev);
#endif

static int amebalite_i2c_process(FAR struct i2c_dev_s *dev, FAR struct i2c_msg_s *msgs, int count);
...
static const struct i2c_ops_s amebalite_i2c_ops = {
	.setfrequency = amebalite_i2c_setfrequency,
	.setaddress = amebalite_i2c_setaddress,
	.write = amebalite_i2c_write,
	.read = amebalite_i2c_read,
#ifdef CONFIG_I2C_WRITEREAD
	.writeread = amebalite_i2c_writeread,
#endif
#ifdef CONFIG_I2C_TRANSFER
	.transfer = amebalite_i2c_transfer,
#endif
#ifdef CONFIG_I2C_SLAVE
	.setownaddress = amebalite_i2c_setaddress, //amebalite_i2c_setownaddress,
	.registercallback = amebalite_i2c_registercallback
#endif
};
...
static struct amebalite_i2c_priv_s amebalite_i2c1_priv = {
	.ops = &amebalite_i2c_ops,
	.config = &amebalite_i2c1_config,
	.refs = 0,
	.intstate = INTSTATE_IDLE,
	.msgc = 0,
	.msgv = NULL,
...
static useconds_t amebalite_i2c_tousecs(int msgc, FAR struct i2c_msg_s *msgs)
{
	...
	return (useconds_t)(CONFIG_AMEBALITE_I2C_DYNTIMEO_USECPERBYTE * bytecount);
}
#endif

/************************************************************************************
 * Name: amebalite_i2c_sem_waitdone
 *
 * Description:
...
#if CONFIG_AMEBALITE_I2CTIMEOSEC > 0
		abstime.tv_sec += CONFIG_AMEBALITE_I2CTIMEOSEC;
#endif

		/* Add a value proportional to the number of bytes in the transfer */

#ifdef CONFIG_AMEBALITE_I2C_DYNTIMEO
		abstime.tv_nsec += 1000 * amebalite_i2c_tousecs(priv->msgc, priv->msgv);
		if (abstime.tv_nsec > 1000 * 1000 * 1000) {
			abstime.tv_sec++;
			abstime.tv_nsec -= 1000 * 1000 * 1000;
		}
#elif CONFIG_AMEBALITE_I2CTIMEOMS > 0
		abstime.tv_nsec += CONFIG_AMEBALITE_I2CTIMEOMS * 1000 * 1000;
		if (abstime.tv_nsec > 1000 * 1000 * 1000) {
			abstime.tv_sec++;
			abstime.tv_nsec -= 1000 * 1000 * 1000;
		}
...
static inline int amebalite_i2c_sem_waitdone(FAR struct amebalite_i2c_priv_s *priv)
{
...
#ifdef CONFIG_AMEBALITE_I2C_DYNTIMEO
	timeout = USEC2TICK(amebalite_i2c_tousecs(priv->msgc, priv->msgv));
#else
	timeout = CONFIG_AMEBALITE_I2CTIMEOTICKS;
#endif
	...
	do {
		...
		ret = amebalite_i2c_isr_process(priv);
...
/************************************************************************************
 * Name: amebalite_i2c_sem_waitstop
 *
 * Description:
...
static inline void amebalite_i2c_sem_post(struct amebalite_i2c_priv_s *priv)
{
	sem_post(&priv->sem_excl);
}

/************************************************************************************
 * Name: amebalite_i2c_sem_init
 *
 * Description:
...
/************************************************************************************
 * Name: amebalite_i2c_sem_destroy
 *
 * Description:
 *   Destroy semaphores.
 *
...
#ifdef CONFIG_I2C_TRACE
static void amebalite_i2c_traceclear(FAR struct amebalite_i2c_priv_s *priv)
{
	struct amebalite_trace_s *trace = &priv->trace[priv->tndx];
...
static void amebalite_i2c_traceevent(FAR struct amebalite_i2c_priv_s *priv, enum amebalite_trace_e event, uint32_t parm)
{
	struct amebalite_trace_s *trace;
...
/************************************************************************************
 * Name: amebalite_i2c_isr_process
 *
 * Description:
...
static int amebalite_i2c_isr(int irq, void *context, FAR void *arg)
{
	struct amebalite_i2c_priv_s *priv = (struct amebalite_i2c_priv_s *)arg;

	DEBUGASSERT(priv != NULL);
	return amebalite_i2c_isr_process(priv);
}
#endif

/************************************************************************************
 * Name: amebalite_i2c_init
 *
 * Description:
...
#endif
#ifndef CONFIG_I2C_POLLED
	irq_attach(priv->config->irq, amebalite_i2c_isr, priv);
	up_enable_irq(priv->config->irq);
#endif
 ...
 ************************************************************************************/
/************************************************************************************
 * Name: amebalite_i2c_setfrequency
 *
 * Description:
...
static uint32_t amebalite_i2c_setfrequency(FAR struct i2c_dev_s *dev, uint32_t frequency)
{
	...
	amebalite_i2c_sem_post(priv);
	return ((struct amebalite_i2c_priv_s *)dev)->frequency;
}

/************************************************************************************
 * Name: amebalite_i2c_setaddress
 *
 * Description:
...
static int amebalite_i2c_setaddress(FAR struct i2c_dev_s *dev, int addr, int nbits)
{
	...
	((struct amebalite_i2c_priv_s *)dev)->flags = (nbits == 10) ? I2C_M_TEN : 0;
...
static int amebalite_i2c_process(FAR struct i2c_dev_s *dev, FAR struct i2c_msg_s *msgs, int count)
{
	...
	int ret = 0;
	ret = amebalite_i2c_sem_waitdone(priv);
...
static int amebalite_i2c_writeread(FAR struct i2c_dev_s *dev, const uint8_t *wbuffer, int wbuflen, uint8_t *buffer, int buflen)
{
	...
	amebalite_i2c_sem_wait(priv);	/* Ensure that address or flags don't change meanwhile */
        ...
        return amebalite_i2c_process(dev, msgv, 2);
}
#endif

#ifdef CONFIG_I2C_TRANSFER
/************************************************************************************
 * Name: amebalite_i2c_transfer
 *
 * Description:
...
{
	struct amebalite_i2c_priv_s *priv = NULL;
	irqstate_t flags;
 ...
 /* Initialize private data for the first time, increment reference count,
	...
	*/
	...
	if ((volatile int)priv->refs++ == 0) {
		amebalite_i2c_sem_init(priv);
		amebalite_i2c_init(priv);
	}
...
int up_i2cuninitialize(FAR struct i2c_dev_s *dev)
{
	...
	amebalite_i2c_deinit(priv);

	/* Release unused resources */

	amebalite_i2c_sem_destroy(priv);
	return OK;
}
...
{
	FAR struct amebalite_i2c_priv_s *priv = (FAR struct amebalite_i2c_priv_s *)dev;
